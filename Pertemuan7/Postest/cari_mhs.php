...
<table border="1">
    ...
    <?php if (isset($_GET['cari'])) { //jika variabel cari terdapat value maka akan dilakukanlah proses dibawah ini
        ...
        $sql = "select * from siswa where nama like'%" . $cari . "%'"; // mengambil sekaligus menampilkan data dengan klausa where nim = $cari
    ...
    ?>
        <tr>
            <td><?php echo $no++; ?></td>
            <td><?php echo $r['nama']; ?></td><!-- menampilkan data nama -->
        </tr>
    <?php } ?>
</table>