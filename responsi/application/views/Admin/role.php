                ...
                <tbody>
                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td><?= $r['role'] ?></td>
                            <td>
                                <a href="<?= base_url('Admin/Role/roleAccess/') . $r['id']; ?>" class="badge badge-warning"> Access</a>
            ...
            <form action="<?= base_url('Admin/Role'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Masukan Nama Role" name="role">
                    </div>
                </div>
